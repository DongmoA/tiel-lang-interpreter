...
public sealed abstract class Expr implements Positionable<Expr> permits ArrayAccesExpr, ArrayLiteralExpr, AssignExpr, BinaryExpr, CallExpr, LiteralExpr,
        LogicalExpr, UnaryExpr, VariableExpr, ClassAccessExpr {
